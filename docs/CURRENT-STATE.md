...
| Smoke Plumes ≋ | NOAA OSPO Hazard Mapping System smoke polygons (keyless KML day files; previous-day fallback right after 00:00 UTC) | `src/layers/smoke/` via `src/app/layers/smoke.js` | `/api/smoke` | 10 min (server cache 10 min) |
